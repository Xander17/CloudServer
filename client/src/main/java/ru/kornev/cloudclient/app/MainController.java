...
import ru.kornev.cloudclient.app.controllers.LoginWindowController;
import ru.kornev.cloudclient.app.controllers.tables.TableFilesLocalController;
import ru.kornev.cloudclient.app.controllers.tables.TableFilesServerController;
import ru.kornev.cloudclient.network.NetworkThread;
...
public class MainController implements Initializable {
    ...
    public void localFileNotExist(String filename) {
        refreshClientList();
        addToLog("Local file " + filename + " is not exist");
    }
